...
class ShortCourseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Map courses to their specific images from training_programs folder
        $courseImageMap = [
            'Welding' => 'Welding.jpg',
            'Pipe Fitter' => 'PIPE FITTER 3.jpg',
            'Steel Fitter' => 'STEEL FITTER.jpg',
            'Scaffolding' => 'scrbHolding.jpeg',
            'Mechanical Fitter' => 'M3.jpg',
            'Machinist' => 'machinist.webp',
            'Electrician' => 'Electrician.jpeg',
            'Blaster Painter' => 'Blaster_Painter.png',
        ];

        // Available images from img folder (for courses without specific images)
        $availableImages = [
        ...
        $courses = [
            [
                'title' => 'Welding',
                'img' => $this->copyImageFromTrainingPrograms('Welding.jpg'),
            ...
            [
                'title' => 'Pipe Fitter',
                'img' => $this->copyImageFromTrainingPrograms('PIPE FITTER 3.jpg'),
            ...
            [
                'title' => 'Steel Fitter',
                'img' => $this->copyImageFromTrainingPrograms('STEEL FITTER.jpg'),
            ...
            [
                'title' => 'Scaffolding',
                'img' => $this->copyImageFromTrainingPrograms('scrbHolding.jpeg'),
            ...
            [
                ...
                'img' => $this->copyImageFromTrainingPrograms('M3.jpg'),
            ...
            [
                'title' => 'Machinist',
                'img' => $this->copyImageFromTrainingPrograms('machinist.webp'),
            ...
            [
                'title' => 'Electrician',
                'img' => $this->copyImageFromTrainingPrograms('Electrician.jpeg'),
            ...
            [
                ...
                'img' => $this->copyImageFromTrainingPrograms('Blaster_Painter.png'),
    ...
    /**
     * Copy image from public/img/training_programs to storage/app/public/short-courses
     */
    private function copyImageFromTrainingPrograms(?string $imageName): ?string
    {
        if (!$imageName) {
            return null;
        }

        $sourcePath = public_path('img/training_programs/' . $imageName);
